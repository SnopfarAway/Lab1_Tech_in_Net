...
var eq = require("./dist/mod"); // подключить созданный модуль 


var _require = require("crypto"),
    randomInt = _require.randomInt; // подключить модуль генерации случайного числа
...
var readline = require("readline-sync"); // подключить модуль считывания с консоли 
